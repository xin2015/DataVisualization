...
(function (global, factory) {
    ...
    function _getKrigingGridInfo2(featureCollection, weight, krigingParams, extent) {
        //先获取featureCollection的bbox
        let values = [], lons = [], lats = [];
        featureCollection.features.forEach(feature => {
            //提取插值权重字段，准备克里金插值使用
    ...
    */
    ...
    function getVectorContour2(featureCollection, weight, krigingParams, breaks, extent) {
        let gridinfo = _getKrigingGridInfo2(featureCollection, weight, krigingParams, extent);
        let vectorContour = kriging.getVectorContour(gridinfo, breaks);
        return vectorContour;
    }
    ...
    */
    ...
    function drawCanvasContour2(featureCollection, weight, krigingParams, canvas, extent, colors) {
        let gridinfo = _getKrigingGridInfo2(featureCollection, weight, krigingParams, extent);
        kriging.drawCanvasContour(gridinfo, canvas, [extent[0], extent[2]], [extent[1], extent[3]], colors);
    }

    exports.drawCanvasContour = drawCanvasContour;
    exports.drawCanvasContour2 = drawCanvasContour2;
    exports.getVectorContour = getVectorContour;
    exports.getVectorContour2 = getVectorContour2;
